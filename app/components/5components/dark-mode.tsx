...
export default function DarkMode() {
  ...
  return (
    <div className="relative flex h-full w-full items-center justify-center">
      <div className="relative z-10 h-80 w-60 overflow-hidden rounded-xl border border-neutral-100 bg-neutral-50 shadow-2xl dark:border-neutral-800 dark:bg-neutral-900">
        <div className="relative mask-t-from-50% mask-r-from-50% mask-b-from-50% mask-l-from-50%">
          <Pattern />
          <div className="animate-marquee flex h-40 items-center justify-center gap-4">
            {icons.map((icon) => (
              <div
                className="flex size-10 items-center justify-center rounded-full bg-neutral-300 dark:bg-neutral-700"
                key={icon.title}
              >
                {icon.icon}
              </div>
        ...
        <div className="p-4">
          <h2 className="text-[8px] font-bold text-neutral-600 dark:text-white">
            These LLMs are getting out of hands
          </h2>
          <p className="mt-2 text-[8px] text-neutral-400 dark:text-neutral-300">
            There are new models every month, each with new capabilities and
            quirks. I swear they are evolving too fast! Keeping up with the
            latest releases is almost a full-time job. Who knows what surprises
            next month will bring?
          </p>
          <button
            onClick={handleThemeChange}
            className="mt-4 flex cursor-pointer items-center gap-2 rounded-lg bg-neutral-100 px-2 py-1 text-[10px] text-neutral-500 dark:bg-neutral-800 dark:text-white"
          >
